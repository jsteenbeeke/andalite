...
public class ClassLocator {
	private final IJavaNavigation<AnalyzedClass> navigation;

	private ClassLocator(@Nonnull IJavaNavigation<AnalyzedClass> navigation) {
		this.navigation = navigation;
	}

	@Nonnull
	IJavaNavigation<AnalyzedClass> getNavigation() {
		return navigation;
	}
