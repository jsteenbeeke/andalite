...
public class AnalyzerTest extends DummyAwareTest {
	...
	public void testAnalyzer() {
		TypedResult<AnalyzedSourceFile> result = analyzeAndVerify("src/test/java/com/jeroensteenbeeke/andalite/analyzer/AnalyzerTest.java");
	...
	private TypedResult<AnalyzedSourceFile> analyzeAndVerify(File file) {
		...
		TypedResult<AnalyzedSourceFile> result = classAnalyzer.analyze();
		assertTrue(result.isOk(), String.format("File %s should be parseable", file.getAbsolutePath()));
