...
public class MavenQuestionRenderer implements QuestionRenderer, FeedbackHandler
{
	...
	private static final Logger log = LoggerFactory.getLogger(MavenQuestionRenderer.class);
	...
	@Override
	public TypedResult<ForgeRecipe> renderRecipeSelection(@NotNull List<ForgeRecipe> recipeList)
	{
	...
	private TypedResult<File> renderFileSelectQuestion(FileSelectQuestion question)
	{
		TypedResult<Integer> response = createPlaceholder();
	...
	private TypedResult<AnalyzedSourceFile>
			renderSourceFileSelectQuestion(SourceFileSelectQuestion question)
	{
		TypedResult<Integer> response = createPlaceholder();
	...
	private TypedResult<String> renderSimpleQuestion(SimpleQuestion question)
	{
		String answer = null;
		while (!question.isValidAnswer(answer))
		{
