...
public class TypeArgumentContextAdapter implements Adapter<Type, Java8Parser.TypeArgumentContext> {
    public Type adapt(Java8Parser.TypeArgumentContext context, AdapterParameters adapterParameters) {
