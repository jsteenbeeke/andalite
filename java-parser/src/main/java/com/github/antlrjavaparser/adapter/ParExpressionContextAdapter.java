...
public class ParExpressionContextAdapter implements Adapter<Expression, Java8Parser.ParExpressionContext> {
    public Expression adapt(Java8Parser.ParExpressionContext context, AdapterParameters adapterParameters) {
