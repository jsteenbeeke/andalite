 ...
 * Date: 8/22/2014
 */
public class DefaultInterfaceMethodDeclarationContextAdapter implements Adapter<BodyDeclaration, Java8Parser.DefaultInterfaceMethodDeclarationContext>  {
    @Override
    public BodyDeclaration adapt(Java8Parser.DefaultInterfaceMethodDeclarationContext context, AdapterParameters adapterParameters) {
