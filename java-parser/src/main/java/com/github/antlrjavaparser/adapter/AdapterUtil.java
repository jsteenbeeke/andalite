...
public final class AdapterUtil {
    ...
    public static void setVariableModifiers(Java8Parser.VariableModifiersContext context, Resource resource, AdapterParameters adapterParameters) {
    ...
    public static void setVariableModifiers(Java8Parser.VariableModifiersContext context, CatchParameter parameter, AdapterParameters adapterParameters) {
        /*
        variableModifiers
