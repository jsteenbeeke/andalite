...
public class LocalVariableDeclarationStatementContextAdapter implements Adapter<Statement, Java8Parser.LocalVariableDeclarationStatementContext> {
    public Statement adapt(Java8Parser.LocalVariableDeclarationStatementContext context, AdapterParameters adapterParameters) {
