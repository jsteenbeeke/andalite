...
public class AnnotationTypeDeclarationContextAdapter
		implements
		Adapter<AnnotationDeclaration, Java8Parser.AnnotationTypeDeclarationContext> {
	public AnnotationDeclaration adapt(
		...
		AdapterUtil.setModifiers(context.modifiers(), annotationDeclaration,
				adapterParameters);
		AdapterUtil.setComments(annotationDeclaration, context,
				adapterParameters);
		AdapterUtil.setPosition(annotationDeclaration, context);
		annotationDeclaration.setName(context.Identifier());
		annotationDeclaration.setMembers(Adapters
				.getAnnotationTypeBodyContextAdapter().adapt(
						context.annotationTypeBody(), adapterParameters));
