...
public class AdditiveExpressionContextAdapter implements Adapter<Expression, Java8Parser.AdditiveExpressionContext> {
    public Expression adapt(Java8Parser.AdditiveExpressionContext context, AdapterParameters adapterParameters) {

        List<Java8Parser.MultiplicativeExpressionContext> contextList = context.multiplicativeExpression();
    ...
    private BinaryExpr.Operator getOperator(Java8Parser.AdditiveOpContext operatorContext) {
