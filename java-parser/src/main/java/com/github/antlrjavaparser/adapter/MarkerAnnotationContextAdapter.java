...
public class MarkerAnnotationContextAdapter implements Adapter<MarkerAnnotationExpr, Java8Parser.MarkerAnnotationContext> {
    public MarkerAnnotationExpr adapt(Java8Parser.MarkerAnnotationContext context, AdapterParameters adapterParameters) {
