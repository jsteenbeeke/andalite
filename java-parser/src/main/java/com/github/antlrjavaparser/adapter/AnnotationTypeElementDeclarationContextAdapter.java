...
public class AnnotationTypeElementDeclarationContextAdapter implements Adapter<BodyDeclaration, Java8Parser.AnnotationTypeElementDeclarationContext> {
    public BodyDeclaration adapt(Java8Parser.AnnotationTypeElementDeclarationContext context, AdapterParameters adapterParameters) {
