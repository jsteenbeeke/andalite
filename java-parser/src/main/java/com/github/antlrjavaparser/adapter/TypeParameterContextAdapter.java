...
public class TypeParameterContextAdapter implements Adapter<TypeParameter, Java8Parser.TypeParameterContext> {
    public TypeParameter adapt(Java8Parser.TypeParameterContext context, AdapterParameters adapterParameters) {
