...
public class PrimaryContextAdapter implements Adapter<Expression, Java8Parser.PrimaryContext> {
    public Expression adapt(Java8Parser.PrimaryContext context, AdapterParameters adapterParameters) {
    ...
    // Identifier (DOT Identifier)* (identifierSuffix)?   {$operationType = 3;}
    private Expression handleIdentifierSuffix(Java8Parser.PrimaryContext primaryContext, AdapterParameters adapterParameters) {
        /*
            identifierSuffix
            locals [int operationType]
                :   (LBRACKET RBRACKET)+ DOT CLASS                      {$operationType = 1;}
    ...
    // THIS (DOT Identifier)* (thisSuffix)?               {$operationType = 2;}
    private Expression handleThisSuffix(Java8Parser.PrimaryContext primaryContext, AdapterParameters adapterParameters) {
        /*
            thisSuffix
            locals [int operationType]
                :   (LBRACKET expression RBRACKET)+                     {$operationType = 1;}
