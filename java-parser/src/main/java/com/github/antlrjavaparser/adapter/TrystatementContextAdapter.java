...
public class TrystatementContextAdapter implements Adapter<Statement, Java8Parser.TrystatementContext> {
    public Statement adapt(Java8Parser.TrystatementContext context, AdapterParameters adapterParameters) {
