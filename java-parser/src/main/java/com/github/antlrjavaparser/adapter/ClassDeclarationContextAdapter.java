...
public class ClassDeclarationContextAdapter implements Adapter<TypeDeclaration, Java8Parser.ClassDeclarationContext> {
    public TypeDeclaration adapt(Java8Parser.ClassDeclarationContext context, AdapterParameters adapterParameters) {
