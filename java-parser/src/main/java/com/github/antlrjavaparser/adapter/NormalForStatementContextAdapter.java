 ...
 */
public class NormalForStatementContextAdapter implements Adapter<ForStmt, Java8Parser.NormalForStatementContext> {
    @Override
    public ForStmt adapt(Java8Parser.NormalForStatementContext context, AdapterParameters adapterParameters) {
