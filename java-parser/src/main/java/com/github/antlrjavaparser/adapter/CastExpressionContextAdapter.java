...
public class CastExpressionContextAdapter implements Adapter<Expression, Java8Parser.CastExpressionContext> {
    public Expression adapt(Java8Parser.CastExpressionContext context, AdapterParameters adapterParameters) {
