...
public class ResourceContextAdapter implements Adapter<Resource, Java8Parser.ResourceContext> {
    public Resource adapt(Java8Parser.ResourceContext context, AdapterParameters adapterParameters) {
        /*
            resource
