...
public class EnumBodyDeclarationsContextAdapter implements Adapter<List<BodyDeclaration>, Java8Parser.EnumBodyDeclarationsContext> {
    public List<BodyDeclaration> adapt(Java8Parser.EnumBodyDeclarationsContext context, AdapterParameters adapterParameters) {
