...
public class ContextCreator {
    ...
    public static void main(String args[]) throws Exception {
        for (String context : contexts) {
            ...
            out.println("package com.github.antlrjavaparser.adapter;");
            out.println("");
            out.println("import net.java.antlrjavaparser.api.Node;");
            out.println("import net.java.antlrjavaparser.Java8Parser;");
            out.println("");
            out.println("public class " + context + "Adapter implements Adapter<Node, Java8Parser." + context + "> {");
            out.println("    public Node adapt(Java8Parser." + context + " context) {");
