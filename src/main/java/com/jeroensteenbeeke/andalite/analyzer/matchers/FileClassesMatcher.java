...
class FileClassesMatcher extends
		ByPropertyMatcher<AnalyzedSourceFile, List<AnalyzedClass>> {

	public FileClassesMatcher(Matcher<List<AnalyzedClass>> delegateMatcher) {
